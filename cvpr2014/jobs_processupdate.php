...
function sendEmail( $name, $email, $title, $job_id, $randkey )
{
      ...
      $message .= "http://www.pamitc.org/cvpr13/jobs_handle.php?action=confirm&job_id=$job_id&key=$randkey\r\n\r\n";
      ...
      $message .= "http://www.pamitc.org/cvpr13/jobs_handle.php?action=revise&job_id=$job_id&key=$randkey\r\n\r\n";
