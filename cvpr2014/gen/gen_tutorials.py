...
def dump_start( fp ):
    ...
    print >>fp, '<table>\n<tr><td colspan="3" align="center"><h2>CVPR 2014 Accepted Tutorials</h2><br/>Organizers, please contact the <a href="http://www.google.com/recaptcha/mailhide/d?k=01VJaxQuH5TSFlMs9ukFD_cA==&c=GP8iwEfxR72664efAY4EDVwv7oXZ6WJL0M45Zn2UXtz2G6m_gUofETEcJroKO5Su" target="_blank">Website Chairs</a> with needed updates. </td></tr>'
...
if four_col:
    ...
    print >>OUT, '<tr><td width="15%" align="center"><u><b>Date</b></u></td><td width="*"><u><b>Tutorial Title / Organizers</b></u></td></tr>\n\n'
...
with open('input/tutorial_info.json','r') as jsonfile:
    ...
    #for tutorial in BY_NAME:
        ...
        if not info['tutorial_date'] == '':
            ...
            elif info['tutorial_length'] == 'half':
                ws_date = '%s</br><i>(Half-day)</i>'% info['tutorial_date']
