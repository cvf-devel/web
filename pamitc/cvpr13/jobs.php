...
<?php
    ...
    //no guarantee that this will make a difference...
    $host    ="205.178.146.109";
    $username="pamitc";
    $password="Pam1tc5qL";
    $database= "pamitcjobs";
    /* this was original connection code
    ...
    */
    ...
    {
        //  ADD  //
        echo "<tr><td align=\"center\" colspan=\"2\"><span class=\"cvprpageheader\">CVPR Job Board - New Posting</span><br><br></td></tr>";
?>
<tr><td>
...
<?php
    ...
    elseif ($action == "revise")
    {
        //  VIEW  //
        $key = $_GET['key'];
        echo "<tr><td align=\"center\" colspan=\"2\"><span class=\"cvprpageheader\">CVPR Job Board - Revise Posting</span><br><br></td></tr>";
...
<?php
    ...
    {
        //  VIEW  //
        echo "<tr><td align=\"center\" colspan=\"2\"><span class=\"cvprpageheader\">CVPR Job Board - Posting Details</span><br><br></td></tr>";
...
<?php
    ...
    {
        //  LIST  //
        echo "<tr><td align=\"center\" colspan=\"2\"><span class=\"cvprpageheader\">CVPR Job Board ($numrows Postings)</span><br><br>"
?>
    <form action="jobs.php" method="get">
