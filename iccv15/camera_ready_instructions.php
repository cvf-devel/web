...
<center>
<table>
<tbody><tr><td colspan="3" align="center"><span class="iccvparagraphheader">Instructions for Validation and Final Submission of ICCV 2015 Camera-Ready Papers</span><br />
</td></tr>
<tr><td colspan="3">

<p><b>Note: in addition to the instructions below, please see the
	<a href="video_spotlight_instructions.php">video spotlight
		instructions</a>, which are due October 9, 2015.</b></p>

<p>Please read these instructions carefully and follow them exactly
to minimize problems with production of the conference
proceedings.</p>

<p>The deadline for final submission (completion of all steps below)
is <span class="boldred">Sept. 25, 2015 at 11:59pm</span> Pacific Daylight Time.  This deadline
will not be extended.  Papers that arrive after the deadline may not
appear on the conference USB drive, and may not be placed in IEEE
Xplore.</p>
...
published exclusively for meeting attendees.  All ICCV papers that are
...
<p>There are four steps to completing your final ICCV 2015 paper
submission:</p>

<ol type="1" class="body_ul">
<li>Validate your camera-ready paper (without page numbers) using IEEE PDF eXpress.</li>
<li>Register at least one author for ICCV 2015.</li>
<li>Submit the validated PDF and paper information to the paper collection site (<a href="https://cmt.research.microsoft.com/ICCV2015/">https://cmt.research.microsoft.com/ICCV2015/</a>).</li>
...
<pThere is a strict size limit of 10 MB (10,485,760 bytes) for PDF
...
<p>The page limit for all papers is 8 pages (with one additional page
allowed that contains only cited reference).  To clarify, the main
body of the paper, including figures, tables, equations,
acknowledgments, etc., must be limited to no more than 8 pages.  An
additional page may only contain cited references.  Note that, unlike
previous years, there are no paper or extra-page fees.  However,
papers that are longer than 8 pages (not including references), will
not be processed and will not appear on the conference USB drive or on
IEEE Xplore.</p>

<p>IEEE requires that all papers to be entered into the IEEE Xplore
...
the <a href="http://www.pamitc.org/iccv15/author_guidelines.php">ICCV
2015 web site</a>.</p>
...
own PDF file, PDF eXpress can validate it.  If you are using any of
the following document formatting systems, PDF eXpress can generate an
...
<li>Login to PDF express: <a href="https://www.pdf-express.org/">https://www.pdf-express.org/</a><br />

The conference ID is: 33071X</li>
...
<li><p>Register at least one author for the conference at <a
href="http://www.pamitc.org/iccv15/registration.php">http://www.pamitc.org/iccv15/registration.php</a>
or by following the Registration link from the main ICCV 2015 web
...
due to no-shows will not appear in IEEE Xplore.</p></li>

<li>Final paper submission for production<br />

<p>Deadline: Sept. 25, 2015.  The deadline for all ICCV 2015 papers is <span class="boldred">Sept. 25, 2015 at 11:59pm</span> Pacific Daylight Time.  This deadline will not be extended.  Papers that arrive after the deadline may not appear on the conference USB drive, and may not be placed in IEEE Xplore.</p>

<ol type="a" class="body_ul">

<li><p>Login to the CMT paper collection site: <a href="https://cmt.research.microsoft.com/ICCV2015/">https://cmt.research.microsoft.com/ICCV2015/</a></p></li>

<li><p>In the CMT "Author Console", your accepted paper(s) will appear
...
title and author list and submitting your camera-ready paper.</p></li>
...
<li><p>In the "Authors" page, check that all the authors included in the camera-ready paper also appear in their proper order on CMT.  Please check that all author names are spelled correctly and are in the correct order.</p></li>

<li><p>The name of your camera-ready submission must be in the form
...
"File Upload" page.</p></li>

<li><p>If you wish to provide supplementary material, the file name must be in the form XXXX-supp.pdf or XXXX-supp.zip, where XXXX is the zero-padded, four-digit paper ID as used in step e.  Upload your supplemental file on the "File Upload" page as a single PDF or ZIP file of 20 MB in size or less.  Only PDF and ZIP files are allowed for supplementary material.  You can put anything in this file - movies, code, additional results, accompanying technical reports--anything that may make your paper more useful to readers.  If your supplementary material includes video or image data, you are advised to use common codecs and file formats.  This will make the material viewable by the largest number of readers (a desirable outcome).  Please note that supplemental material will only be included on the USB proceedings; it will NOT be archived on IEEE Xplore.</p></li>

<li><p>Check that the upload of your file (or files) was successful
...
camera-ready submission.</p></li>

<li><p>You must agree to all the questions on the "Additional Questions"
...
<li><p>Don't forget to click the "Finish" button on the "Confirmation"
...
<p>Final reminder: Papers will appear in the ICCV 2015 USB
proceedings and placed in IEEE Xplore only if all of these conditions
are met:</p>

<ol type="a" class="body_ul">

<li>The final PDF submission is 10 MB or less in size, 8 pages (not including cited references) or less in length, has been validated by PDF eXpress, and has been uploaded to the paper collection web site (after validation) by Sept. 25, 2015 at 11:59pm Pacific Daylight Time.</li>

<li>Any supplemental material file (if applicable) has been uploaded
to the submission site by Sept. 25, 2015.</li>

<li>At least one author registers for and attends ICCV 2015.</li>
