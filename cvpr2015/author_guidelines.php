...
<center>
<table>
<tbody><tr><td colspan="3" align="center"><span class="cvprpageheader">Author Guidelines</span><br><br>
<span class="cvprsectionheader"><a href="http://www.pamitc.org/cvpr15/files/CFP2015.pdf">Official Call for Papers</a></span><br><br>
</td></tr>
<tr><td colspan="3">
<span class="cvprsectionheader">Submission Instructions</span>
<br><br>
All submissions will be handled electronically via the conference's <a href="https://cmt.research.microsoft.com/CVPR2015/">CMT Website</a>. All authors must agree to the policies stipulated below.  
<!--The submission deadline is November 14th and cannot be changed.-->
...
<br>
<ul>
<li>Example submission paper with detailed instructions: <a target="_blank" href="http://www.pamitc.org/cvpr15/files/egpaper_for_review.pdf">egpaper_for_review.pdf</a></li>
<li>LaTeX/Word Templates (tar): <a href="http://www.pamitc.org/cvpr15/files/cvpr2015AuthorKit.tgz">cvpr2015AuthorKit.tgz</a></li>
<li>LaTeX/Word Templates (zip): <a href="http://www.pamitc.org/cvpr15/files/cvpr2015AuthorKit.zip">cvpr2015AuthorKit.zip</a></li>
</ul>
...
<span class="cvprparagraphheader">Conflict Responsibilities:</span> It is the primary author's responsibility to ensure that <b>all</b>
...
example paper <a target="_blank" href="http://www.pamitc.org/cvpr15/files/egpaper_for_review.pdf">egpaper_for_review.pdf</a>
...
(preserving anonymity as described in Section 1.6 of the example paper <a target="_blank" href="http://www.pamitc.org/cvpr15/files/egpaper_for_review.pdf">egpaper_for_review.pdf</a>),
...
<br><br>
Our policy is based upon the following particular definition of &ldquo;publication&rdquo;.
...
&ldquo;counts as a publication&rdquo;. 

<br><br> 
Note that such a definition does not consider an <a href="http://arxiv.org/">arXiv.org</a> paper as a publication
...
<ul>
<li> A NIPS <a href="http://www.dlworkshop.org/"> Deep Learning workshop </a> paper with substantial overlap. This would
...
of workshop organizers that papers in this workshop do not count as publications.</li>

<li> A short 
<a href="http://openreview.net/venue/iclr2014"> ICLR </a>
...
background, such a submission could be allowable.</li>

<li> An <a href="http://arxiv.org/">arXiv.org</a> paper  on the same topic. Because this paper is not peer-reviewed
...
similar CVPR paper.</li>
</ul>

Authors are encouraged to contact the <a href="http://www.google.com/recaptcha/mailhide/d?k=017ZRqNZ7cqo3l_BJoipSiog==&amp;c=9v-TZXHgTg1r5jMztKS4regmvRS8dUJvJs-hUo1iJmI=" onclick="window.open('http://www.google.com/recaptcha/mailhide/d?k\075017ZRqNZ7cqo3l_BJoipSiog\75\75\46c\759v-TZXHgTg1r5jMztKS4regmvRS8dUJvJs-hUo1iJmI\075', '', 'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=500,height=300'); return false;" title="Reveal this e-mail address">Program Chairs</a> about clarifications on borderline
cases.
...
available at <a href="http://www.cv-foundation.org/">http://www.cv-foundation.org/</a>
<br><br>
...
<li>All supplementary material must be self-contained and zipped into a 
...
<li>Please make sure that the supplementary material directly supports 
...
paper deadline is not allowed.</li>
...
<ul>
<li><a target="_blank" href="https://cmt.research.microsoft.com/CVPR2015/">Submission Site</a> (bookmark or save this URL!)</li>
...
</li><li><span class="cvprparagraphheader">If you have been invited to review for CVPR2015:</span><br>
...
<br>
<span class="cvprparagraphheader">If you have not been invited to review for CVPR2015:</span>
<br>
...
<br>
</li><li><span class="cvprparagraphheader">Logging in the first time:</span><br>
...
</li><li><span class="cvprparagraphheader">Update contact information:</span><br>
...
</li><li><span class="cvprparagraphheader">Enter subject (topic) areas for your paper:</span><br>
...
</li><li><span class="cvprparagraphheader">Enter Institutional Conflicts</span><br>
...
</li><li><span class="cvprparagraphheader">Paper Number</span><br>
...
</li><li><span class="cvprparagraphheader">Requirements:</span><br>
<ul>
...
<li>If your submission has co-authors, please make sure that you enter 
...
also have their conflict domains entered.</li>
</ul>
</li></ol>
...
material. See <a href="#SupplementaryMaterial">Supplementary Material</a>.</span></li>
...
online copy.</span></li>
<li><span class="faq_q">What is CVPR 2015 policy on DUAL SUBMISSIONS?</span><br>
...
etc.) with publication available online count as a prior publication, and
 therefore is that work ineligible for review and publication at CVPR 2015?</span><br>
<span class="faq_a">Please read the <a href="#dual">dual/double submission paragraph</a> above.</span></li>
<li><span class="faq_q">Does a presentation at a departmental seminar during the review period violate the anonymity standard or other CVPR 2015 policy?</span><br>
...
<ul>
<li><span class="faq_q">Is the CVPR 2015 Review Process CONFIDENTIAL?</span><br>
<span class="faq_a"><b>YES,</b> CVPR 2015 Reviewing is considered 
...
<li><span class="faq_q">Are CVPR 2015 Reviews Double BLIND or Single BLIND?</span><br>
<span class="faq_a">CVPR reviewing is <b>Double BLIND</b>, in that 
...
Please read Section 1.6 of the example paper <a target="_blank" href="http://www.pamitc.org/cvpr15/files/egpaper_for_review.pdf">egpaper_for_review.pdf</a>
 for detailed instructions on how to preserve anonymity. Avoid providing
 information that may identify the authors in the acknowledgments (e.g.,
 co-workers and grant IDs) and in the supplemental material (e.g., 
titles in the movies, or attached papers). Avoid providing links to 
