...
<table>
<tr><td colspan="3" align="center"><span class="iccvpageheader">Area Chair Guidelines</span><br><br>
</td></tr>
<tr><td colspan="3">
This page provides detailed guidelines to Area Chairs of ICCV 2013 as to how the process will unfold and what are their responsibilities.<br><br>

<span class="iccvparagraphheader">Role of the Area Chairs</span>
<br><br>
The ACs help identify suitable reviewers, assign reviewers to papers, and evaluate the reviews as well as the authors' responses. ACs are expected to play an active role in ensuring higher quality and more timely reviews, and in initiating discussions amongst reviewers (anonymously), and in looking at authors' responses to the reviews. At the AC meeting in <font color="red">February 2013</font>, ACs will work with other ACs (in pairs and then in panels) to decide which papers to accept and will write consolidation reports to explain the decisions.
<br><br>

<br>
<span class="iccvparagraphheader">Best Practices of Being an Area Chair</span>
<br><br>

We want to remind all ACs of some of the basic (and obvious) practices of being an AC.
<ul>
<li>You have a strong influence on a decision on a paper. Take it seriously and be fair.</li>
<li>DO NOT talk to any other AC about papers assigned to you until you are told about who is on your panel and who your buddy is. There may be several other ACs conflicted with the paper.</li>
...
<li>DO NOT talk to any other AC about your own paper (the paper you are an author on) or a paper you have some conflict with, during this whole process, unless that AC and you are already collaborators and both of you have an already defined conflict.</li>
...
<li>Senior members of the committee should guide and advise the younger and first-time members. First-time members, please feel free to ask for help as needed.</li>
</ul>
...
<br>
<span class="iccvparagraphheader">Consolidation Reports</span>
<br><br>

Area Chair Consolidation Reports are the MOST CRUCIAL aspect of the review process of ICCV. This is where the Area Chair justifies his/her recommendation to accept/reject a paper. The Program Chairs will read all Consolidation Reports and we have committed ourselves to ensure that these reports are representative of a good quality review process. These reports should highlight why the decision was reached. If all reviewers agree on a paper, this consolidation report can be simple, but feel free to encourage authors and provide constructive feedback. If there is even a slight disagreement on the reviews, it is your job to clarify why and how the disagreement was resolved. Again, just saying "reviewer 1 was wrong" without any reasons is not acceptable. Explain why. For the most divergent reviews, explain the process you went through to reach a decision and if you and others read the paper, try to add some details from your and others reviews with the consolidation reports. Overruling all three reviewers to make a decision on a paper is not acceptable. If you strongly feel that the paper deserves that, make sure to discuss it in detail with your AC Buddy and also in your AC Panel. In such cases, (a) you should read the paper completely, (b) provide a detailed consolidation report, and (c) solicit confirmation of the decision from your panel. The program chairs will review and confirm or reverse any such decisions that do not have the consensus support of the panel.
<br><br>

<br>
<span class="iccvsectionheader">Area Chair Instructions</span>
<br><br>

During the reviewing phase, please periodically log in to the <a target="_blank" href="https://cmt.research.microsoft.com/ICCV2013/">CMT site</a> and monitor the review progress.
<br><br>

<span class="iccvparagraphheader">Phase 1 - Assigning Reviewers</span><br>
<br>

The Program Chairs are going to assign papers to you based on (a) papers from authors not in conflict with you (see conflict of interest in the <a href="reviewer_guidelines.php#conflict">Reviewer Instructions</a>), (b) subject areas you chose when you registered on the review site, (c) subject areas, the authors chose when they registered the paper, and (d) results from the “Toronto" document matching system. As can be imagined, this will <b>not</b> be perfect as sometimes the Program Chairs have to do some load-balancing. Area Chairs should look through all the papers assigned to them and ensure that they are (1) not conflicted and (2) are knowledgeable in the subject area.
<br><br>

For each paper you are assigned you must initially <b>select 7 or more candidate reviewers during the reviewer assignment step</b>. After all ACs have completed this step, the CMT system will then select 3 from each candidate list, subject to necessary constraints on reviewer load. If it is not able to assign 3 from your list, it will assign fewer than 3, and you will be required to iterate again suggesting additional reviewers. <b>CMT will not assign a reviewer to a paper that you have not suggested. Several iterations may be necessary if you only suggest the minimal number of candidate reviewers, and those will occur in a relatively short cycle (24 or 48 hours)</b>. If you plan to only assign the minimal number of reviewers, please expect to be available on short notice to add a few more to the papers which are not satisfied on the first round. If you will be unavailable for several days, it is better to assign 10 or more candidate reviewers. <b>Please assign as many candidate reviewers as possible to each paper, as long as you are comfortable getting any subset of 3 actually assigned</b>. You must assign at least 7, and the more you assign, the greater the chances you will not be required to suggest additional reviewer names for that paper. While CMT will not automatically do so, the program chairs may personally assign reviewers based on preference keyword match or any other scheme necessary to papers of ACs who do not respond in a timely manner.
<br><br>

Here are some suggestions on how to proceed. It can take anywhere from 4-6 minutes a paper do this, if you look at the paper and other info to help make a decision. Considering a max load of 35 papers, you can see that this may take some time. See <a href="reviewer_guidelines.php#instructions">Reviewer Instructions</a>  for details of how to use the system to assign reviewers.

<ul>

<li>You have been chosen as an Area Chair because of your specific expertise in certain areas of vision and also your general expertise in computer vision. When you look at a paper, you may just come up with a name or three of ideal reviewers. Consider these people as the reviewers for this, but do also consider things like, (a) are they current in the field and (b) will they do a good job in a timely manner.</li>

<li>Look at the paper, especially the Introduction, Related Work, and Citations at the end. See who they refer to and whose work they are building on. Often the cited people would be ideal reviewers.</li>

<li>Remember that the system will give you some recommendations, based on matching subject areas and document statistics. This may provide a good starting point, but will not be perfect.</li>

<li>Usually, we suggest that you choose a reviewer you know and trust. But the vision community is large. If the system recommends someone you do not know, look at their webpage or their papers on ACM or IEEE digital libraries or Google Scholar and the like.</li>
...
<br>
<span class="iccvparagraphheader">Phase 2 - Check Incoming Reviews</span><br>
<br>

After you have ranked reviewers, the Program Chairs, with the review system's help will distribute papers to the reviewers. During this phase, we recommend that you log into the system to check if any reviews are being entered. Remember that the reviewers <b>do not know</b> your identity, so it is best if you do not contact them and/or identify yourself. This is yet another form of "anonymity" in the review process, as we don't want the reviewers to be unduly influenced by anyone. If reviews are showing up, look at them and see if (a) the reviewer has added sufficient detail and (b) has used appropriate tone in the review, and most importantly (c) provided a knowledgeable review. Contact the reviewers via the review system to get them to clarify issues from the review. Doing this during the process will reduce how much you need to do at the deadline when reviews are due.
<br><br>

After the review deadline has passed, check if all reviews are in. If not, send them a note and nicely <b>demand</b> that they finish the reviews ASAP. The system will also send reminders to them. 
<ul>
</li>
...
<li>
<b>Important note on emailing via CMT</b>: Since any email sent on your behalf is anonymously sent through CMT, the communication is <b>one way only</b>. Please tell your email recipients not to respond to the email, because there is no automatic routing of email to you. So, be very specific about what you would like the reviewer(s) to do, e.g., improve their review in a certain way.
</li>
...
<br>
<span class="iccvparagraphheader"><a name="discussion"></a>Phase 3 - Discussion Phase</span><br>
<br>

Right after the review deadline, please look through ALL the reviews.. If any review appears unreasonable (e.g., one-liner comments or overly harsh), please contact the reviewer and ask for clarification. Remember that communication is only one-way, so be specific about what you need from the reviewer. Check again in one or two days to see if there is any update to that review. Since we will not be keeping track of your emails, so please do the book-keeping yourself (best to make a note of what you've done).  Again, you may find it helpful to create and maintain your own spreadsheet to keep track of the reviews, scores, and any high-level discussion items or to-do lists.
<br><br>

<span class="iccvparagraphheader">3.1. When to Initiate a Discussion</span>
<br><br>

Please start a discussion any time you feel that the overall scores and/or the comments are insufficient to allow you to make a decision (e.g., all "Borderlines"). <b>At the very least</b>, initiate a discussion if the difference between the maximum and minimum scores is greater than 2 levels.
<br><br>

<span class="iccvparagraphheader">3.2. During the Discussion</span>
<br><br>

You play the role of a moderator in the discussion. While it is ideal to reach a consensus, don't feel obligated to force one - the discussions are mainly to allow you to make more informed decisions. It is ok if the reviewers end up not changing their overall scores as long as you've gained a better understanding of how they arrived at their scores. Stick to the facts, and do not influence the outcome of the discussion by imposing your views on the paper. However, if you disagree with the majority view, say so, provide compelling reasons, and solicit feedback from the reviewers. If the discussion looks like it is getting out of hand (e.g., when a reviewer makes inappropriate remarks or a battle of words erupts), please contact us (<a href="http://www.google.com/recaptcha/mailhide/d?k=01q-31RtaoNPER-uCcqWOcPQ==&c=C6DoW64GC7OOTL6bGXsxZmtZeE2ZYkuYZbCMtrjkyQMnEr87r08IRFpf1wK3q33B" target="_blank">email</a>) immediately. Don't forget to let us know the paper number. For cases of "Borderlines", if the discussion appears to not to be heading towards any decision, we suggest you ask the question "If you had to choose now, would you accept or reject this paper?"
<br><br>

<span class="iccvparagraphheader">3.3. Anonymous Discussion Feature</span>
<br><br>
...
<li><span class="boldred">You must do the following steps to enable the reviewers to participate in the discussion. Emailing the reviewers via CMT is NOT the right way to initiate the discussion.</span></li>
...
<li>Please sign your posts as "Area Chair", and identify the reviewers by the review number. <b>Never identify yourself or other reviewers by name</b>.</li>

<li>Anytime a post is made (either by the area chair or a reviewer), the area chair and reviewers will receive an email notification from CMT with the subject that looks like "ICCV2013: New reviewer discussion posted for Paper ID XXX". There is a link in the email you can use to join the discussion (after logging in, you will be routed directly to the discussion page). Alternatively, you can just log in to CMT as usual.</li>
...
<br>
<span class="iccvparagraphheader">Phase 4 - Rebuttal Period</span><br>
<br>
...
<br>
<span class="iccvparagraphheader">Phase 5 - Review Author Feedback and Discuss with Reviewers</span><br>
<br>

You should be able to see the Author Rebuttal/Feedback to the reviews. .You can start a discussion using the discussion board (see Phase 3: <a href="#discussion">Discussion Phase</a>) with the reviewers of the papers, especially if the rebuttal is responding to a specific review. While, the reviews cannot be changed, you can take the input from the reviewers at this phase to help in your proposed decision and the consolidation report that you have drafted (or will!). Make sure to be clear about how the rebuttal was taken into account in the consolidation report. Remember, all consolidation reports are considered a draft and all decisions are just proposed and will be finalized at the AC Meeting.
<br><br>

<span class="iccvparagraphheader">Consolidation Scores on the AC Website</span>
<br><br>
...
<br>
<span class="iccvparagraphheader">Phase 6 - Prepare for AC Meeting Discuss with AC Buddies, Propose Decisions on Paper</span><br>
<br>

The Area Chair Meeting will occur <font color="red">February 23-24, 2013 in Los Angeles</font>.
...
<br>
<span class="iccvsectionheader">Area Chair FAQs</span>
<br><br>
<span class="iccvparagraphheader">Conflicts with Papers Assigned to Area Chairs</span><br>
<ul>
...
<span class="faq_a">Thanks for letting us know. Yes, this does qualify as a conflict of interest so we will assign to some other Area Chair.</span></li>
...
<li><span class="faq_q">I have a paper assigned to me that appears to be very similar to one that I have just co-authored for ICCV 2013. I can be still objective in review of this paper, irrespective of my submission.</span><br>
...
<span class="iccvparagraphheader">Assigning Reviewers</span><br>
<ul>

<li><span class="faq_q">What should I do with a paper with the names of the authors explicitly mentioned?</span><br>
<span class="faq_a">Papers with authors’ names explicitly violate the anonymity requirement of ICCV and will be rejected. Let the Program Chairs know the paper id.</span></li>

<li><span class="faq_q">What should I do with a paper that did not exactly follow the required format?</span><br>
<span class="faq_a">If the paper is still 2 column style ICCV format (missing the line numbers, paper id on every page, etc.) and not longer than 8 pages (font not too small, margins ok, etc.), then it is fine to assign reviewers. (We don't want to be too rigid.)</span></li>
...
<span class="iccvparagraphheader">Area Chairs Meeting</span><br>
<ul>

<li><span class="faq_q">When and where is the Area Chairs' Meeting?</span><br>
<span class="faq_a">AC Meeting will be held on <font color="red">Feb 23-24. All AC are expected to arrive on Feb 22 (Fri), 2013, and be there until the session ends on the evening of Feb 26 (Sun), which will then be followed by a dinner.  All ACs are invited to stay an extra day, Feb 25 (Mon)</font>, 2013 to participate in an informal workshop on computer vision and related topics.</span></li>
